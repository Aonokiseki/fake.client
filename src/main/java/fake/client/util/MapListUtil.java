...
public class MapListUtil {
	...
	public static String mapListConvertToSQL(String dbName, List<Map<String, Object>> mapList) {
		return mapListConvertToSQL(dbName, mapList, false);
	}
	public static String mapListConvertToSQL(String dbName, List<Map<String, Object>> mapList, boolean ignore) {
		List<String> columnNames = mapListGlobalKeySet(mapList);
		StringBuilder sqlBuilder = new StringBuilder();
		sqlBuilder.append("insert");
		if(ignore)
			sqlBuilder.append(" ignore");
		sqlBuilder.append(" into ").append(dbName).append("(");
		int columnIndex = 0;
