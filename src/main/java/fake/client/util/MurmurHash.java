...
public class MurmurHash {
	...
	public static int hash32(ByteBuffer date, int seed){
		return hash32(date,0,date.remaining(),seed);
	}
    ...
    public static long hash64(ByteBuffer date, int seed) {
        return hash64(date, 0, date.remaining(), seed);
    }
    ...
    public static long hash(String val) {
        ...
        return 0xffffffffffffL & hash64(ByteBuffer.wrap(bytes), 0, bytes.length, 0);
    }

    public static long hash(long val) {
        return hash(String.valueOf(val));
    }

    public static long hash(int val) {
        return hash(String.valueOf(val));
    }
