...
public class SummaryRequestBody {
	...
	@ApiModelProperty(value = "分词服务名")
	private String segmentServiceName;
	...
	public String getSegmentServiceName() {
		return segmentServiceName;
	}
	public void setSegmentServiceName(String segmentServiceName) {
		this.segmentServiceName = segmentServiceName;
	}
}
